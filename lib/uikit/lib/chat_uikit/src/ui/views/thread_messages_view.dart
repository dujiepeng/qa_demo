...
class _ThreadMessagesViewState extends State<ThreadMessagesView>
  ...
  void updateAppBarModel() {
    appBarModel = ChatUIKitAppBarModel(
      ...
      trailingActions: () {
        ...
        return widget.appBarModel?.trailingActionsBuilder?.call(
              context,
              actions,
            ) ??
            actions;
              ...
              child: GestureDetector(
                ...
                child: ThreadMessageListView(
                  ...
                  onItemLongPress: (context, model, rect) {
                    bool? ret = widget.onItemLongPress?.call(
                      context,
                      model,
                      rect,
                    );
  ...
  Widget alertItem(BuildContext context, Widget? child, MessageModel model) {
    Widget? content;
      ...
      content ??= ChatUIKitMessageListViewAlertItem(
        actions: [
          MessageAlertAction(
            ...
            onTap: () {
              ChatUIKitProfile profile = ChatUIKitProvider.instance.getProfile(
                ChatUIKitProfile.contact(id: map[alertOperatorIdKey]!),
              );
              pushNextPage(profile);
            },
          ),
