...
class _ConversationsViewState extends State<ConversationsView>
  ...
  void updateAppBarModel(ChatUIKitTheme theme) {
    appBarModel = ChatUIKitAppBarModel(
      ...
      titleTextStyle:
          widget.appBarModel?.titleTextStyle ??
          TextStyle(
      ...
      leadingActions:
          ...
          () {
            ...
            return widget.appBarModel?.leadingActionsBuilder?.call(
                  context,
                  actions,
                ) ??
                actions;
  ...
  void onSearchTap(List<ConversationItemModel> data) {
    ...
    ChatUIKitRoute.pushOrPushNamed(
      ...
      SearchViewArguments(
        ...
        searchHideText: ChatUIKitLocal.conversationsViewSearchHint.localString(
          context,
        ),
        searchData: list,
  ...
  void longPressed(ConversationItemModel info) async {
    ...
    if (widget.onItemLongPressHandler != null) {
      list = widget.onItemLongPressHandler?.call(
        context,
        info,
        defaultLongPressActions(info),
      );
    } else {
    ...
    return [
      ChatUIKitEventAction.normal(
        ...
        label: info.noDisturb
            ? ChatUIKitLocal.conversationListLongPressMenuUnmute.localString(
                context,
              )
            : ChatUIKitLocal.conversationListLongPressMenuMute.localString(
                context,
              ),
        onTap: () async {
      ...
      ChatUIKitEventAction.normal(
        ...
        label: info.pinned
            ? ChatUIKitLocal.conversationListLongPressMenuUnPin.localString(
                context,
              )
            : ChatUIKitLocal.conversationListLongPressMenuPin.localString(
                context,
              ),
        onTap: () async {
      ...
      if (info.unreadCount > 0)
        ChatUIKitEventAction.normal(
          ...
          label: ChatUIKitLocal.conversationListLongPressMenuRead.localString(
            context,
          ),
          onTap: () async {
      ...
      ChatUIKitEventAction.destructive(
        ...
        label: ChatUIKitLocal.conversationListLongPressMenuDelete.localString(
          context,
        ),
        onTap: () async {
  ...
  void showMoreInfo() {
    ...
    showChatUIKitBottomSheet(
      cancelLabel: ChatUIKitLocal.conversationsViewMenuCancel.localString(
        context,
      ),
      context: context,
      items: list,
  ...
  List<ChatUIKitEventAction> defaultItems() {
    return [
      ChatUIKitEventAction.normal(
        ...
        label: ChatUIKitLocal.conversationsViewMenuCreateNewChat.localString(
          context,
        ),
        icon: Icon(
          Icons.message,
      ...
      ChatUIKitEventAction.normal(
        ...
        label: ChatUIKitLocal.conversationsViewMenuAddContact.localString(
          context,
        ),
        icon: Icon(
      ...
      ChatUIKitEventAction.normal(
        ...
        label: ChatUIKitLocal.conversationsViewMenuCreateGroup.localString(
          context,
        ),
        icon: Icon(
          Icons.group,
  ...
  void newConversations() async {
    ChatUIKitRoute.pushOrPushNamed(
      ...
      SelectContactViewArguments(
        appBarModel: ChatUIKitAppBarModel(
          title: ChatUIKitLocal.conversationsViewMenuCreateNewChat.localString(
            context,
          ),
        ),
        attributes: widget.attributes,
