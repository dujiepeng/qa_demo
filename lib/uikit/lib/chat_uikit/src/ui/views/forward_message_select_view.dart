...
class _ForwardMessageSelectViewState extends State<ForwardMessageSelectView>
  ...
  void updateAppBarModel(ChatUIKitTheme theme) {
    appBarModel = ChatUIKitAppBarModel(
      ...
      onBackButtonPressed:
          widget.appBarModel?.onBackButtonPressed ??
          () {
      ...
      body: Column(
        children: [
          TabBar(
            ...
            tabs: [
              Tab(
                text: ChatUIKitLocal.forwardSelectContacts.localString(context),
              ),
              Tab(
                text: ChatUIKitLocal.forwardSelectGroups.localString(context),
              ),
            ],
          ),
          Expanded(
                ...
                GroupsView(
                  ...
                  itemBuilder: (context, model) {
                    Widget item = Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Expanded(child: ChatUIKitGroupListViewItem(model)),
                        SizedBox(
                          width: 80,
                          height: 40,
  ...
  Widget forwardButton(ChatUIKitTheme theme, String profileId, bool isGroup) {
