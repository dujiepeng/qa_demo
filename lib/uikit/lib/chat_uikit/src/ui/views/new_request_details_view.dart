...
class NewRequestDetailsView extends StatefulWidget {
  NewRequestDetailsView.arguments(
    NewRequestDetailsViewArguments arguments, {
    super.key,
  ...
  Widget _buildContent() {
    ...
    Widget button = Container(
      ...
      child: Center(
        child: Text(
          widget.btnText ??
              ChatUIKitLocal.newRequestDetailsViewAddContact.localString(
                context,
              ),
          textScaler: TextScaler.noScaling,
          overflow: TextOverflow.ellipsis,
  ...
  void addAction() async {
    ...
    try {
      if (widget.isReceivedRequest) {
        ...
        try {
          await ChatUIKit.instance.sendContactRequest(
