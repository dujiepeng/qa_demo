...
class _ContactDetailsViewState extends State<ContactDetailsView>
  ...
  Widget _buildContent() {
    ...
    models.add(
      ChatUIKitDetailsListViewItemModel(
        title: ChatUIKitLocal.contactDetailViewDoNotDisturb.localString(
          context,
        ),
    ...
    models.add(
      ChatUIKitDetailsListViewItemModel(
        title: ChatUIKitLocal.contactDetailViewClearChatHistory.localString(
          context,
        ),
  ...
  void deleteContact() async {
    final ret = await showChatUIKitDialog(
      title: ChatUIKitLocal.contactDetailViewDeleteAlertTitle.localString(
        context,
      ),
      content: ChatUIKitLocal.contactDetailViewDeleteAlertSubTitle.localString(
        context,
      ),
      context: context,
      actionItems: [
    ...
    if (ret == true) {
      ChatUIKit.instance
          .deleteContact(userId: profile!.id)
          .then((value) {
