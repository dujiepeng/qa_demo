...
class CreateGroupView extends StatefulWidget {
  CreateGroupView.arguments(CreateGroupViewArguments arguments, {super.key})
...
class _CreateGroupViewState extends State<CreateGroupView>
              ...
              ChatUIKitAppBarAction(
                ...
                child: Text(
                  selectedProfiles.isEmpty
                      ? ChatUIKitLocal.createGroupViewCreate.localString(
                          context,
                        )
  ...
  void onSearchTap(List<ContactItemModel> data) async {
    ...
    ChatUIKitRoute.pushOrPushNamed(
      ...
      SearchViewArguments(
        ...
        searchHideText: ChatUIKitLocal.createGroupViewSearchContact.localString(
          context,
        ),
        searchData: list,
        enableMulti: true,
  ...
  void createGroup() async {
    ...
    if (widget.createHandler != null) {
      info = await widget.createHandler!(context, selectedProfiles);
    }
    ...
    ChatUIKit.instance
        .createGroup(
          ...
          options: GroupOptions(
            maxCount:
                info?.maxCount ?? widget.createGroupInfo?.maxCount ?? 1000,
            style:
                info?.style ??
                widget.createGroupInfo?.style ??
                GroupStyle.PrivateMemberCanInvite,
            inviteNeedConfirm:
                info?.inviteNeedConfirm ??
