...
class ContactsView extends StatefulWidget {
  ContactsView.arguments(ContactsViewArguments arguments, {super.key})
...
class _ContactsViewState extends State<ContactsView>
  ...
  void tapContactInfo(ChatUIKitProfile profile) {
    ChatUIKitRoute.pushOrPushNamed(
      ...
      ContactDetailsViewArguments(profile: profile),
    ).then((value) {
  ...
  void addContact() async {
    String? userId = await showChatUIKitDialog(
      ...
      content: ChatUIKitLocal.contactsAddContactAlertSubTitle.localString(
        context,
      ),
      context: context,
      inputItems: [
        ChatUIKitDialogInputContentItem(
          hintText: ChatUIKitLocal.contactsAddContactAlertHintText.localString(
            context,
          ),
        ),
      ],
      actionItems: [
        ChatUIKitDialogAction.cancel(
          label: ChatUIKitLocal.contactsAddContactAlertButtonCancel.localString(
            context,
          ),
          onTap: () async {
