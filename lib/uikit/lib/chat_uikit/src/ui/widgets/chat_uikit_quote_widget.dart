...
class _ChatUIKitQuoteWidgetState extends State<ChatUIKitQuoteWidget>
  ...
  void loadMessage() async {
    message = await ChatUIKit.instance.loadMessage(messageId: model.msgId);
    fetched = true;
    if (mounted) setState(() {});
  }
    ...
    Widget content = Row(
      ...
      children: [
        SizedBox(
          width: 16,
          height: 16,
          child: ChatUIKitImageLoader.bubbleVoice(
            2,
            color: theme.color.isDark
                ? theme.color.neutralColor6
                : theme.color.neutralColor5,
        ...
        Flexible(
          ...
          child: RichText(
            ...
            text: TextSpan(
              children: [
                TextSpan(
                  text: ChatUIKitLocal.quoteWidgetTitleVoice.localString(
                    context,
                  ),
                  style: TextStyle(
        ...
        Flexible(
          child: RichText(
            ...
            text: TextSpan(
              children: [
                TextSpan(
                  text: ChatUIKitLocal.quoteWidgetTitleFile.localString(
                    context,
                  ),
                  style: TextStyle(
                    fontWeight: theme.font.labelSmall.fontWeight,
        ...
        Flexible(
          child: RichText(
            ...
            text: TextSpan(
              children: [
                TextSpan(
                  text: ChatUIKitLocal.quoteWidgetTitleCombine.localString(
                    context,
                  ),
                  style: TextStyle(
                    fontWeight: theme.font.labelSmall.fontWeight,
          ...
          Flexible(
            child: RichText(
              ...
              text: TextSpan(
                children: [
                  TextSpan(
                    text: ChatUIKitLocal.quoteWidgetTitleContact.localString(
                      context,
                    ),
                    style: TextStyle(
                      fontWeight: theme.font.labelMedium.fontWeight,
