...
class _ChatUIKitReplyBarState extends State<ChatUIKitReplyBar>
  ...
  Widget themeBuilder(BuildContext context, ChatUIKitTheme theme) {
    Widget content = Column(
      ...
      children: [title(theme), const SizedBox(height: 4), subTitle(theme)],
    );
        ...
        Expanded(
          child: RichText(
            ...
            text: TextSpan(
              children: [
                TextSpan(
                  text: ChatUIKitLocal.replayBarTitleCombine.localString(
                    context,
                  ),
                  style: TextStyle(
                    fontWeight: theme.font.labelSmall.fontWeight,
          ...
          Expanded(
            child: RichText(
              ...
              text: TextSpan(
                children: [
                  TextSpan(
                    text: ChatUIKitLocal.replayBarTitleContact.localString(
                      context,
                    ),
                    style: TextStyle(
                  ...
                  TextSpan(
                    text:
                        widget.messageModel.message.cardUserNickname ??
  ...
  Widget _imagePreview() {
    return () {
      ...
      if (widget.messageModel.message.thumbnailLocalPath?.isNotEmpty == true) {
        ...
        if (file.existsSync()) {
          content = Image(
            image: ResizeImage(FileImage(file), width: 36, height: 36),
