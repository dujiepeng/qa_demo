...
typedef ChatUIKitDownloadBuilder =
    Widget Function(
...
typedef ChatUIKitDownloadResult =
...
class _ChatUIKitDownloadsHelperWidgetState
  ...
  ValueNotifier<ChatUIKitMessageDownloadState> isDownloading = ValueNotifier(
    ChatUIKitMessageDownloadState.idle,
  );
...
enum ChatUIKitMessageDownloadState { idle, downloading, success, error }
