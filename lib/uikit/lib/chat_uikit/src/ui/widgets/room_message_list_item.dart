  ...
  static Widget getMessageListItem(
    ...
    if (message.bodyType == MessageType.CUSTOM) {
      if (message.isChatRoomJoinNotify) {
        return RoomUserJoinMessageListItem(
          message,
          user,
          showTime: showTime,
        ...
        return RoomGiftMessageListItem(
          message,
          user,
          showTime: showTime,
          showIdentify: showIdentify,
      ...
      return RoomTextMessageListItem(
        message,
        user,
        showTime: showTime,
        showIdentify: showIdentify,
            ...
            child: Container(
              ...
              child: ChatRoomImageLoader.roomNetworkImage(
                ...
                placeholderWidget:
                    ...
                    ? Container()
                    : Image.asset(
                        ChatUIKitSettings.roomDefaultIdentify!,
                        width: 15,
                        height: 15,
                      ),
              ),
...
class _RoomUserJoinMessageListItemState
    extends State<RoomUserJoinMessageListItem>
    with ChatUIKitThemeMixin {
  @override
  Widget themeBuilder(BuildContext context, ChatUIKitTheme theme) {
    return RoomMessageListItem(
      ...
      inlineSpan: TextSpan(
        children: [
          ...
          TextSpan(
            text:
                gift!.giftName ??
                ChatUIKitLocal.roomGiftDefaultName.localString(context),
          ),
          WidgetSpan(
            child: Container(
              clipBehavior: Clip.hardEdge,
              ...
              child: ChatRoomImageLoader.roomNetworkImage(
                ...
                placeholderWidget:
                    ...
                    ? Container()
                    : Image.asset(ChatUIKitSettings.roomDefaultGiftIcon!),
              ),
            ),
            alignment: PlaceholderAlignment.middle,
          ),
  ...
  Widget themeBuilder(BuildContext context, ChatUIKitTheme theme) {
    ...
    for (var element in EmojiMapping.emojiImages) {
      ...
      do {
        ...
        indexList.add(
          EmojiIndex(emoji: element, index: indexFirst, length: element.length),
        );
    ...
    if (lastIndex != null) {
      ...
      list.add(TextSpan(text: content));
    }
