...
typedef ChatRoomShowGiftItemBuilder =
    Widget? Function(
      String senderId,
      ChatRoomGift gift,
...
class _ChatRoomShowGiftViewState extends State<ChatRoomShowGiftView>
  ...
  Widget themeBuilder(BuildContext context, ChatUIKitTheme theme) {
      ...
      slivers: [
        SliverList(
          delegate: SliverChildBuilderDelegate((
            ...
            return Container(height: totalHeight, color: Colors.transparent);
          }, childCount: 1),
        ),
        SliverList(
          delegate: SliverChildBuilderDelegate(
    ...
    content = SizedBox(height: totalHeight, child: content);
...
class GiftItem extends StatelessWidget {
  ...
  Widget item(BuildContext context) {
    ...
    // 礼物图片
    list.add(
      ChatRoomImageLoader.roomNetworkImage(
        image: gift.giftIcon,
        size: 40,
        fit: BoxFit.fill,
