...
typedef ListViewBuilder =
    Widget Function(
      BuildContext context,
      List<ChatUIKitListItemModelBase> list,
    );

typedef ChatUIKitListItemBuilder =
...
class _ChatUIKitListViewState extends State<ChatUIKitListView>
  ...
  Widget themeBuilder(BuildContext context, ChatUIKitTheme theme) {
    ...
    if (sliverView != null) {
      sliverView = SliverFillRemaining(hasScrollBody: false, child: sliverView);
    }
                ...
                Flexible(
                  ...
                  child: Text(
                    widget.searchBarHideText ??
                        ChatUIKitLocal.conversationsViewSearchHint.localString(
                          context,
                        ),
                    textScaler: TextScaler.noScaling,
                    style: TextStyle(
