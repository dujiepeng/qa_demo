...
enum ChatUIKitMessageListViewBubbleStyle { arrow, noArrow }
            ...
            padding: () {
              if (widget.padding != null) {
                return EdgeInsets.only(
                  left: widget.padding!.left + (widget.isLeft ? arrowWidth : 0),
                  right:
                      widget.padding!.right + (!widget.isLeft ? arrowWidth : 0),
...
class _BubblePainter extends CustomPainter {
  _BubblePainter({required this.color, this.isLeft = true});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (isLeft) {
      ...
      path.lineTo(
        ...
        size.height - arrowPosition - arrowHeight,
      );
    }
