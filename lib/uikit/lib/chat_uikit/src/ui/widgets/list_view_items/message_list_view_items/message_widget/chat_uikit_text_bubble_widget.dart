...
class ChatUIKitTextBubbleWidget extends StatelessWidget {
    ...
    if (model.message.textContent.hasURL() &&
      ...
      contents.add(
        Padding(
          ...
          child: Text(
            ChatUIKitLocal.messageTextWidgetURLPreviewParsing.localString(
              context,
            ),
  ...
  double getSize(BuildContext context, ChatUIKitTheme theme) {
    ...
    TextPainter painter1 = TextPainter(
      text: TextSpan(text: model.message.textContent, style: tmpStyle),
      textDirection: TextDirection.ltr,
    )..layout(minWidth: 0, maxWidth: double.infinity);

    TextPainter painter2 = TextPainter(
      text: TextSpan(text: model.message.translateText, style: tmpStyle),
      textDirection: TextDirection.ltr,
    )..layout(minWidth: 0, maxWidth: double.infinity);
    ...
    return max(
          max(painter1.size.width, painter2.size.width),
