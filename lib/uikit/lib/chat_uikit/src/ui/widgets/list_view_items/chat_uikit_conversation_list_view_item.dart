  ...
  Widget build(BuildContext context) {
              ...
              children: [
                ...
                Expanded(
                  child: ChatUIKitEmojiRichText(
                    textScaler: TextScaler.noScaling,
                    text:
                        info.lastMessage?.showInfoTranslate(
                          context,
                          needShowName: true,
                        ) ??
                        '',
    ...
    if (info.noDisturb) {
      unreadCount = showUnreadCount && info.unreadCount > 0
          ...
          : const SizedBox();
      unreadCount = Center(child: unreadCount);
    } else {
      unreadCount =
          showUnreadCount &&
              info.unreadCount > 0 &&
    ...
    unreadCount = SizedBox(height: 20, child: unreadCount);
      ...
      children: [
        ...
        Positioned(
          ...
          left: (ChatUIKitSettings.showConversationListAvatar && showAvatar)
              ? 16
              : 0 -
                    ((ChatUIKitSettings.showConversationListAvatar ||
                            showAvatar)
                        ? 60
                        : 0),
          right: 0,
