...
enum ChatUIKitDialogRectangleType { circular, filletCorner, rightAngle }

enum ChatUIKitDialogActionType { confirm, inputConfirm, cancel, destructive }

class ChatUIKitDialogAction<T> {
  ChatUIKitDialogAction.cancel({required this.label, this.style, this.onTap})
    : type = ChatUIKitDialogActionType.cancel,
      onInputsTap = null;

  ChatUIKitDialogAction.confirm({required this.label, this.style, this.onTap})
...
class _ChatUIKitDialogState extends State<ChatUIKitDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      ...
      child: SizedBox(width: width, child: _buildContent(context)),
    );
  }
  ...
  _buildContent(BuildContext context) {
    ...
    contentWidget = Scrollbar(child: contentWidget);
  ...
  List<Widget> actionsWidget(ChatUIKitTheme theme) {
    ...
    // 破坏性按钮颜色
    Color destructiveColor = themeColor.isDark
    ...
    // 破坏性按钮边框颜色
    Color destructiveBorderColor = themeColor.isDark
        ? themeColor.errorColor6
        : themeColor.errorColor5;

    // 确认按钮颜色
    Color confirmColor = themeColor.isDark
    ...
    // 确认按钮被禁止时文字颜色
    Color confirmForbiddenTextColor = themeColor.isDark
        ? themeColor.neutralColor5
        : themeColor.neutralColor7;
        ...
        widgets.add(
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                borderRadius: borderRadius,
                border: Border.all(width: 1, color: destructiveBorderColor),
        ...
        widgets.add(
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                borderRadius: borderRadius,
                border: Border.all(width: 1, color: cancelBorderColor),
                color: cancelColor,
              ),
              child: Center(
                child: Text(
