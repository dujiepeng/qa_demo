...
class ChatroomGiftPageController {
  ...
  ChatroomGiftPageController({required this.title, required this.gifts});
}
...
class _ChatRoomGiftsViewState extends State<ChatRoomGiftsView>
  ...
  void initState() {
    assert(
      widget.giftControllers.isNotEmpty,
      "giftControllers cannot be empty",
    );
    super.initState();
    _tabController = TabController(
      vsync: this,
      length: widget.giftControllers.length,
    );
  }
...
class ChatRoomGiftItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> widgets = [];
    widgets.add(Expanded(child: imageWidget));
